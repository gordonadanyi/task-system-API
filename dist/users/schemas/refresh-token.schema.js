...
let RefreshToken = class RefreshToken extends mongoose_3.Document {
    token;
    userId;
    expiryDate;
};
...
__decorate([
    (0, mongoose_1.Prop)({ required: true, type: mongoose_2.default.Types.ObjectId, ref: 'User', isRequired: true }),
